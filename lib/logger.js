...
class Logger {
	constructor() {
		if (config.logger && config.logger.file && config.logger.file.enable === true) {
    ...
    if (
		...
		if (
			...
			// var OvhStream = require('./OvhStream')
