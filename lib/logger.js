...
class Logger {
  constructor () {
    ...
    if (
      config.logger &&
      config.logger.file &&
      convertConfigToBoolean(config.logger.file.enable)
    ) {
      // TODO refactor this
    ...
    if (
      ...
      convertConfigToBoolean(config.logger.console.enable)
    ) {
      this.log.addStream({
    ...
    if (
      ...
      convertConfigToBoolean(config.logger.ringBuffer.enable)
    ) {
    ...
    if (
      ...
      convertConfigToBoolean(config.logger.server.enable)
    ) {
